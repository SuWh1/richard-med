      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mb-2 mt-2 flex items-center gap-1.5">
            ...
            {card.service_name_raw && card.service_name_raw !== card.service_name && (
              <span
                ...
                className="cursor-help text-[#CBD5E1] transition-colors hover:text-muted-foreground"
              >
          ...
          {card.freshness === "stale" && (
            <div className="mb-3 flex items-center gap-1.5 rounded-lg bg-[#FEF3C7] px-3 py-2 text-[11px] text-[#92400E]">
